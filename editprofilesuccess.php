                    ...
                    <div class="styled-form maxwidth-100">
                        ...
                        <div class="row clearfix">
                            <div class="form-group col-lg-12">
                                Your details are updated successfully!<br><br>
                                <a href="dashboard.php"><b>Go to My Dashboard</b></a>
                            </div>
                        </div>
                    </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-lg-3 col-sm-6">
                        <h5>Useful Links</h5>
                        <ul>
                            <li><a href="https://demo.mystudyoffers.com/">Home</a></li>
              ...
              h157.9v117.1L128,187.7l-79.2-52V18.9z M94.7,65H68.8V39.1h25.9V65z M187.3,65h-79.8V47.6h79.8V65z M187.3,97.4H68.8V80h118.5V97.4z
               M187.3,129.9H68.8v-17.4h118.5V129.9z" />
                            ...
                            <p>Get the latest news & updates on Study Abroad!</p>
                            <form action="newsleter-submission.php" method="post">
                                <div class="newsleter-form">
                                    <input type="text" name="txtnlemail" placeholder="Enter your email" required>
