...
<body>
    ...
    <section class="contact-page-section">
        <div class="register-section container">
            <div class="register-box maxwidth-100">
                ...
                <!-- Login Form -->
                <form id="testscoreform">

                    <div class="styled-form maxwidth-100">
                        <div class="sec-title mb-10">
                            <h2 class="title mb-10">My Work Experience</h2>
                        </div>
                        <div class="row clearfix" id="workexperience">
                        </div>
                    </div>

                    <div class="styled-form maxwidth-100 pb-30 pt-30">
                        <div class="sec-title mb-10">
                            <h2 class="title mb-10">My Test Scores</h2>
                        </div>
    ...
    <script src="js/testscore.js"></script>
