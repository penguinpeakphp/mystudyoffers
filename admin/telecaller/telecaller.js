$(function()
{
    ...
    $("#addform").on("submit" , function(e)
    {
        ...
        $.post("../controllers/adminuser/addadminuser.php" , {"adminname":adminname , "adminemail":adminemail, "adminstatus":adminstatus , "adminpassword":adminpassword , "admintype":"telecaller"} , function(data)
        {
            try
            {
                ...
                else
                {
                    ...
                    alert("Telecaller inserted successfully");
    ...
    $("#editform").on("submit" , function(e)
    {
        ...
        $.post("../controllers/adminuser/editadminuser.php" , {"adminid":adminid , "adminname":adminname , "adminemail":adminemail , "adminpassword":adminpassword , "adminstatus":adminstatus , "admintype":"telecaller"} , function(data)
        {
            try
            {
                //Parse the data received from the server
