        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Business Nature List</h5>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Edit Business Nature</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <form id="editform">
                                            <input type="hidden" id="editbusinessid" name="editbusinessid">
                                            <div class="modal-body">
                                                <div class="row mb-3">
                                                    <div class="col-12">
                                                        <label for="editbusinessname" class="form-label">Business Nature Name</label>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-sm-10">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" id="editbusinessstatus" name="editbusinessstatus">
                            ...
                            <div class="modal fade" id="addmodal" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Add Business Nature</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <form id="addform">
                                            <div class="modal-body">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-sm-10">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" id="addbusinessstatus" name="addbusinessstatus">
                                                            <label class="form-check-label" for="addbusinessstatus">
                                                                Active
                                                            </label>
                                                        </div>
                                                    </div>
...
<script src="businessnature.js"></script>
