...
<body>
          ...
          <div class="col-auto ms-auto">
            <div class="right-header">
              <div class="header-info">
                ...
                </svg> Call us : +91 89800 04238 </span>
                <span>|</span>
                <span><svg fill="#000000" height="18px" width="18px" version="1.2" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              ...
              </svg> Email us : admin@mystudyoffers.com</span>
              </div>
              <div class="main_menu">
                <nav class="navbar navbar-expand-lg navbar-light">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      ...
                      <li class="nav-item d-black d-lg-none">   
                        <div class="info-text">
                          <strong>Call us</strong> : +91 89800 04238 <br>
                          <strong>Email us </strong>: admin@mystudyoffers.com
                        </div>
                      </li>
                    </ul>
                  </div>
          ...
          <div class="slider-cont">
            <div class="row">
              <div class="col-sm-6 txt">
                ...
                <a  class="slider-btn">Tap To Apply</a>
              </div>
      ...
      <nav>
        <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
          <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home"
            type="button" role="tab" aria-controls="nav-home" aria-selected="true">USA</button>
          <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button"
            role="tab" aria-controls="nav-profile" aria-selected="false">UK</button>
          <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button"
            role="tab" aria-controls="nav-contact" aria-selected="false">Canada</button>
        </div>
      </nav>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <p>Enter your Details to get connected with Expert Mentors.</p>
                            <form action="add-student.php" name="studentregi" method="post" id="studentregi" onsubmit="return registrationform_check();">
                <div class="form-col">
                  <label for="">Name</label>
                  <input type="text" name="stname" placeholder="enter your name" required>
                </div>
                <div class="form-col">
                  <label for="">Sur Name</label>
                  <input type="text" name="stsurname" placeholder="enter your sur name">
                </div>
                <div class="form-col">
                  <label for="">Phone</label>
                  <input type="text" name="stmobile" placeholder="enter your valid phone number" required>
                </div>
                <div class="form-col">
                  <label for="">Email</label>
                  <input type="text" name="stemail" id="stemail" placeholder="enter your valid email" required>
                </div>
                <div class="form-col">
                  <label for="">Pincode</label>
                  <input type="text" name="stpincode" placeholder="enter your pincode" required>
                </div>
                <div class="form-col form-check">
                  ...
                  <label class="form-check-label" ffor="chkterms">Terms & Conditions</label>
                </div>
                 <div style="visibility:hidden; color:red" id="agree_chk_error">
                  Can't proceed as you didn't agree to the terms!
                  </div>
                <div class="form-col">                  
                  <input type="Submit" name="btnsubmit" value="REGISTER" class="register-btn">
                </div>
              </form>
            </div>
            </div>
  ...
  <script language="javascript" src="js/custom-mix.js"></script>
